function autocompleteLocations(inp, method) {
    /*the autocomplete function takes two arguments,
    the text field element and an array of possible autocompleted values:*/
    var currentFocus;
    /*execute a function when someone writes in the text field:*/
    var uniqueId = Math.random().toString(36).slice(2, 9);
    inp.setAttribute("id", "autocomplete-" + uniqueId);
            ...
            callback: function(r) {
                if (r.message) {
                    ...
                    for (i = 0; i < arr.length; i++) {
                          ...
                          b.innerHTML = "<strong>" + arr[i]['locationName'] + "</strong>";
...
autocompleteLocations(document.querySelector(".hotel-searcher"), 'tourism_portal.api.query.get_locations');
autocompleteLocations(document.querySelector(".transfer-searcher"), 'tourism_portal.api.query.get_locations');
