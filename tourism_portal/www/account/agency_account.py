...
def get_child_company_transactions(company,parent_company, from_date, to_date):
    ...
    return frappe.db.sql("""
        SELECT
        pmnt.name, pmnt.transaction_date as post_date, pmnt.debit, pmnt.credit, pmnt.remarks, (pmnt.debit - pmnt.credit) as balance,  si.voucher_no, si.name as invoice_name, pmnt.parent_amount
        ...
        AND pmnt.docstatus = 1 AND 
        pmnt.transaction_date >= %(from_date)s 
