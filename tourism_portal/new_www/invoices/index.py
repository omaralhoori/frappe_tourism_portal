...
from tourism_portal.api.reserve import get_all_invoices, get_bookings_detials
...
def get_context(context):
    ...
    context.agency_page = True
    
    context.invoices = get_all_invoices(voucher_no=voucher_no, start=start, limit=page_size)
